...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"qdpz","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"], __webpack_require__(/*! ./../../../../../Direct-Software/HBuilderX/plugins/uniapp-cli/node_modules/webpack/buildin/module.js */ 248)(module)))
...
var _log = console.log; // 如果在项目的APP.vue文件中的onlaunch中设置 console.log = ()=> {} 则在此也不会有打印信息
...
var _app = {
  ...
  getPosterUrl: function getPosterUrl(objs) {
    // 后端获取背景图的url路径方法
    var backgroundImage = objs.backgroundImage,
      type = objs.type,
      formData = objs.formData;
...
var _app2 = _interopRequireDefault(__webpack_require__(/*! ./app.js */ 257));
var _QRCodeAlg = _interopRequireDefault(__webpack_require__(/*! ./QRCodeAlg.js */ 259));
var _imageTools = __webpack_require__(/*! ./image-tools.js */ 260);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function returnPromise(obj) {
  var type = obj.type,
    ...
    posterCanvasId = obj.posterCanvasId,
    backgroundImage = obj.backgroundImage,
    reserve = obj.reserve,
    textArray = obj.textArray,
    drawArray = obj.drawArray,
    qrCodeArray = obj.qrCodeArray,
    imagesArray = obj.imagesArray,
    setCanvasWH = obj.setCanvasWH,
    setCanvasToTempFilePath = obj.setCanvasToTempFilePath,
    setDraw = obj.setDraw,
    bgScale = obj.bgScale,
    Context = obj.Context,
    _this = obj._this,
    delayTimeScale = obj.delayTimeScale,
    drawDelayTime = obj.drawDelayTime;
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(rs, rj) {
      var bgObj, params, i, hasAllInfoCallback, _i, drawArrayItem, newData, drawArray_copy, _i2, item, _newData, item_idKey, poster;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              _context2.next = 9;
              return getShreUserPosterBackground({
                backgroundImage: backgroundImage,
                type: type,
                formData: formData
              });
            case 9:
              bgObj = _context2.sent;
            case 10:
              ...
              _app2.default.log('准备设置图片');
              _context2.next = 21;
              return setImage(imagesArray);
            case 21:
              imagesArray = _context2.sent;
            ...
            case 28:
              ...
              _context2.next = 33;
              return _app2.default.downloadFile_PromiseFc(qrCodeArray[i].image);
            case 33:
              qrCodeArray[i].image = _context2.sent;
            case 34:
              i++;
              _context2.next = 28;
              break;
            ...
            case 38:
              ...
              if (!_app2.default.isPromise(drawArray)) {
                _context2.next = 44;
                break;
              }
              _context2.next = 43;
              return drawArray;
            case 43:
              drawArray = _context2.sent;
            case 44:
              if (!(_app2.default.isArray(drawArray) && drawArray.length > 0)) {
                _context2.next = 99;
                break;
              }
            ...
            case 47:
              ...
              newData = void 0;
              _context2.t0 = drawArrayItem.type;
              _context2.next = _context2.t0 === 'image' ? 55 : _context2.t0 === 'text' ? 59 : _context2.t0 === 'qrcode' ? 61 : _context2.t0 === 'custom' ? 67 : _context2.t0 === 'fillrect' ? 68 : _context2.t0 === 'strokeRect' ? 69 : _context2.t0 === 'roundStrokeRect' ? 70 : _context2.t0 === 'roundFillRect' ? 71 : 72;
              break;
            case 55:
              _context2.next = 57;
              return setImage(drawArrayItem);
            case 57:
            ...
            case 61:
              ...
              _context2.next = 64;
              return _app2.default.downloadFile_PromiseFc(drawArrayItem.image);
            case 64:
            ...
            case 74:
              if (newData && _app2.default.isObject(newData)) {
                drawArray[_i] = _objectSpread(_objectSpread({}, drawArrayItem), newData);
              }
              ;
            case 76:
              _i++;
            ...
            case 79:
              ...
              drawArray_copy = (0, _toConsumableArray2.default)(drawArray);
              ...
              _i2 = 0;
            case 85:
              if (!(_i2 < drawArray_copy.length)) {
                _context2.next = 98;
                break;
              }
              item = _objectSpread({}, drawArray_copy[_i2]);
              if (!_app2.default.isFn(item.allInfoCallback)) {
                _context2.next = 95;
                break;
              }
              ...
              if (!_app2.default.isPromise(_newData)) {
                _context2.next = 93;
                break;
              }
              _context2.next = 92;
              return _newData;
            case 92:
              _newData = _context2.sent;
            case 93:
              item_idKey = item[idKey];
              if (!_app2.default.isUndef(item_idKey)) {
                drawArray[item[idKey]] = _objectSpread(_objectSpread({}, item), _newData);
              } else {
      ...
      setTimeout(function () {
        ...
        var fn = function fn() {
          ...
          var data = _objectSpread({
            ...
            destWidth: Number(bgObj.width),
            // 若H5使用这里请不要乘以二
            destHeight: Number(bgObj.height),
            // 若H5使用这里请不要乘以二
            quality: .8,
            fileType: 'jpg'
          }, setObj);
          ...
          canvasToTempFilePathFn = function canvasToTempFilePathFn() {
            var toTempFilePathObj = _objectSpread(_objectSpread({}, data), {}, {
...
// export
function drawFillRect(Context) {
  var drawArrayItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  //填充矩形
...
// export
function drawStrokeRect(Context) {
  var drawArrayItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  //线条矩形
...
// export
function drawRoundStrokeRect(Context) {
  var drawArrayItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var dx = drawArrayItem.dx,
    dy = drawArrayItem.dy,
    width = drawArrayItem.width,
    height = drawArrayItem.height,
    r = drawArrayItem.r,
    lineWidth = drawArrayItem.lineWidth,
    color = drawArrayItem.color;
  r = r || width * .1;
  if (width < 2 * r) {
    r = width / 2;
  }
...
// export
function drawRoundFillRect(Context) {
  var drawArrayItem = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var dx = drawArrayItem.dx,
    dy = drawArrayItem.dy,
    width = drawArrayItem.width,
    height = drawArrayItem.height,
    r = drawArrayItem.r,
    backgroundColor = drawArrayItem.backgroundColor;
  r = r || width * .1;
  if (width < 2 * r) {
    r = width / 2;
  }
...
function setTextFn(Context, textItem) {
  ...
  if (_app2.default.isNotNull_string(textItem.text)) {
    ...
    textItem = _objectSpread(_objectSpread({}, textItem), {}, {
...
function countTextLength(Context, obj) {
  _app2.default.log('计算文字长度, obj:' + JSON.stringify(obj));
  var text = obj.text,
    size = obj.size;
...
function setImage(images) {
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(resolve, rejcet) {
      var i;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _app2.default.log('设置图片数据循环中:' + i);
              _context3.next = 8;
              return setImageFn(images[i]);
            case 8:
              images[i] = _context3.sent;
            case 9:
              i++;
              _context3.next = 4;
              break;
            case 12:
              ...
              break;
            case 14:
              _app2.default.log('images是一个对象');
              _context3.next = 17;
              return setImageFn(images);
            case 17:
...
function setImageFn(image) {
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(resolve, reject) {
      var imgUrl, hasinfoCallBack, imageInfo;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return base64ToPathFn(image.url);
            case 3:
              image.url = _context4.sent;
              imgUrl = image.url;
              _context4.next = 7;
              return _app2.default.downloadFile_PromiseFc(imgUrl);
            case 7:
              ...
              imageInfo = {};
              _context4.next = 13;
              return _app2.default.getImageInfo_PromiseFc(imgUrl);
            case 13:
              imageInfo = _context4.sent;
              if (hasinfoCallBack) {
                image = _objectSpread(_objectSpread({}, image), image.infoCallBack(imageInfo));
              }
...
function setFont() {
  var textItem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
function drawCircleImage(Context, obj) {
  ...
  var dx = obj.dx,
    ...
    dWidth = obj.dWidth,
    dHeight = obj.dHeight,
    circleSet = obj.circleSet,
    imageInfo = obj.imageInfo;
  var x, y, r;
  if ((0, _typeof2.default)(circleSet) === 'object') {
    x = circleSet.x;
    y = circleSet.y;
    r = circleSet.r;
  }
...
function drawRoundRectImage(Context, obj) {
  ...
  var dx = obj.dx,
    ...
    dWidth = obj.dWidth,
    dHeight = obj.dHeight,
    roundRectSet = obj.roundRectSet,
    imageInfo = obj.imageInfo;
  var r;
  if ((0, _typeof2.default)(roundRectSet) === 'object') {
    r = roundRectSet.r;
  }
  r = r || dWidth * .1;
  if (dWidth < 2 * r) {
...
function drawQrCode(Context, qrCodeObj) {
  ...
  if (options.image) {
    ...
    var x = options.dx + Number(((ratioSize - ratioImgSize) / 2).toFixed(2));
    var y = options.dy + Number(((ratioSize - ratioImgSize) / 2).toFixed(2));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return getShreUserPosterBackgroundFc(objs);
            case 4:
              savedFilePath = _context5.sent;
              _app2.default.hideLoading();
...
function getShreUserPosterBackgroundFc(objs, upimage) {
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref6 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(resolve, reject) {
      var image, savedFilePath, imageObj, returnObj;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _app2.default.log('没有从后端获取的背景图片路径, 尝试从后端获取背景图片路径');
              if (!backgroundImage) {
                _context6.next = 7;
                break;
              }
              _context6.t0 = backgroundImage;
              _context6.next = 10;
              break;
            case 7:
              _context6.next = 9;
              return _app2.default.getPosterUrl(objs);
            case 9:
              _context6.t0 = _context6.sent;
            case 10:
              image = _context6.t0;
              _context6.next = 13;
              return base64ToPathFn(image);
            case 13:
              image = _context6.sent;
              _app2.default.log('尝试下载并保存背景图:' + image);
              _context6.next = 17;
              return _app2.default.downLoadAndSaveFile_PromiseFc(image);
            case 17:
              savedFilePath = _context6.sent;
              if (!savedFilePath) {
                _context6.next = 32;
                break;
              }
              _app2.default.log('下载并保存背景图成功:' + savedFilePath);
              _context6.next = 22;
              return _app2.default.getImageInfo_PromiseFc(savedFilePath);
            case 22:
              imageObj = _context6.sent;
              ...
              resolve(_objectSpread({}, returnObj));
              _context6.next = 34;
              break;
            case 32:
              _app2.default.hideLoading();
...
exports.default = void 0;
var _qqmapWxJssdk = _interopRequireDefault(__webpack_require__(/*! ./qqmap-wx-jssdk.js */ 170));
var _amapWx = _interopRequireDefault(__webpack_require__(/*! ./amap-wx.js */ 295));
